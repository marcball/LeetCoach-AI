...
const categories = [
  ...
  { name: "Stack", icon: "⊟", problems: 7, difficulty: "Easy", active: true, link: "/dsa/stack" },
  { name: "Binary Search", icon: "⌖", problems: 7, difficulty: "Easy", active: true, link: "/dsa/binary-search" },
  { name: "Linked List", icon: "⊸", problems: 11, difficulty: "Medium", active: true, link: "/dsa/linked-list" },
  { name: "Trees / BST", icon: "⑂", problems: 9, difficulty: "Medium", active: true, link: "/dsa/trees" },
